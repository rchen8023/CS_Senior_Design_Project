...
model = RandomForestClassifier(bootstrap = True, max_depth = 30, n_estimators=100, max_features='auto', n_jobs = -1, class_weight = {0:1,1:2})
...
for k in range(0, num_trial):
    ...
    num_men = sum(sample_test[:, gender_col])
    num_women = len(label_test) - num_men
    num_urban = sum(sample_test[:,hispanic_col])
    num_rural = len(label_test) - num_urban
    
     # Calculate the number of dropouts for each group (Differnce in Dropout Rate)
    num_men_dropout = len([e for e in range(0, num_test) if label_test[e] == 1 and sample_test[e, gender_col] == 1])
    num_women_dropout = len([e for e in range(0, num_test) if label_test[e] == 1 and sample_test[e, gender_col] == 0])
    num_urban_dropout = len([e for e in range(0, num_test) if label_test[e] == 1 and sample_test[e, hispanic_col] == 1])
    num_rural_dropout = len([e for e in range(0, num_test) if label_test[e] == 1 and sample_test[e, hispanic_col] == 0])
    
    # intersectional
    # Count the number of men in urban, women in rural, women in urban, and men in rural in the testing set
    num_men_urban = len([e for e in range(0, num_test) if sample_test[e, gender_col] == 1 and sample_test[e, hispanic_col] == 1])
    num_women_rural = len([e for e in range(0, num_test) if sample_test[e, gender_col] == 0 and sample_test[e, hispanic_col] == 0])
    num_women_urban = len([e for e in range(0, num_test) if sample_test[e, gender_col] == 0 and sample_test[e, hispanic_col] == 1])
    num_men_rural = len([e for e in range(0, num_test) if sample_test[e, gender_col] == 1 and sample_test[e, hispanic_col] == 0])
    
    # Calculate the number of dropouts for each group (Differnce in Dropout Rate)
    num_Mu_dropout = len([e for e in range(0, num_test) if label_test[e] == 1 and sample_test[e, gender_col] == 1 and sample_test[e, hispanic_col] == 1])
    num_Wr_dropout = len([e for e in range(0, num_test) if label_test[e] == 1 and sample_test[e, gender_col] == 0 and sample_test[e, hispanic_col] == 0])
    num_Wu_dropout = len([e for e in range(0, num_test) if label_test[e] == 1 and sample_test[e, gender_col] == 0 and sample_test[e, hispanic_col] == 1])
    num_Mr_dropout = len([e for e in range(0, num_test) if label_test[e] == 1 and sample_test[e, gender_col] == 1 and sample_test[e, hispanic_col] == 0])
    ...
    for i in range(0, num_train_trial):
        ...
        num_men_incorrect = len([e for e in range(0, num_test) if label_test_predicted[e] == 1 and label_test[e] == 1 and sample_test[e, gender_col] == 1])
        num_women_incorrect = len([e for e in range(0, num_test) if label_test_predicted[e] == 1 and label_test[e] == 1 and sample_test[e, gender_col] == 0])
        num_urban_incorrect = len([e for e in range(0, num_test) if label_test_predicted[e] == 1 and label_test[e] == 1 and sample_test[e, hispanic_col] == 1])
        num_rural_incorrect = len([e for e in range(0, num_test) if label_test_predicted[e] == 1 and label_test[e] == 1 and sample_test[e, hispanic_col] == 0])
        ...
        num_men_predict = len([e for e in range(0, num_test) if label_test_predicted[e] == 1 and sample_test[e, gender_col] == 1])
        num_women_predict = len([e for e in range(0, num_test) if label_test_predicted[e] == 1 and sample_test[e, gender_col] == 0])
        num_urban_predict = len([e for e in range(0, num_test) if label_test_predicted[e] == 1 and sample_test[e, hispanic_col] == 1])
        num_rural_predict = len([e for e in range(0, num_test) if label_test_predicted[e] == 1 and sample_test[e, hispanic_col] == 0])
        ...
        # Calculate the probability we pick someone to dropout and they do not dropout (False Positive Parity)
        num_Mu_incorrect = len([e for e in range(0, num_test) if label_test_predicted[e] == 1 and label_test[e] == 1 and sample_test[e, gender_col] == 1 and sample_test[e, hispanic_col] == 1])
        num_Wr_incorrect = len([e for e in range(0, num_test) if label_test_predicted[e] == 1 and label_test[e] == 1 and sample_test[e, gender_col] == 0 and sample_test[e, hispanic_col] == 0])
        num_Wu_incorrect = len([e for e in range(0, num_test) if label_test_predicted[e] == 1 and label_test[e] == 1 and sample_test[e, gender_col] == 0 and sample_test[e, hispanic_col] == 1])
        num_Mr_incorrect = len([e for e in range(0, num_test) if label_test_predicted[e] == 1 and label_test[e] == 1 and sample_test[e, gender_col] == 1 and sample_test[e, hispanic_col] == 0])
        ...
        # Calculate the probability we predict someone will dropout between groups (Demographic Parity)
        num_Mu_predict = len([e for e in range(0, num_test) if label_test_predicted[e] == 1 and sample_test[e, gender_col] == 1 and sample_test[e, hispanic_col] == 1])
        num_Wr_predict = len([e for e in range(0, num_test) if label_test_predicted[e] == 1 and sample_test[e, gender_col] == 0 and sample_test[e, hispanic_col] == 0])
        num_Wu_predict = len([e for e in range(0, num_test) if label_test_predicted[e] == 1 and sample_test[e, gender_col] == 0 and sample_test[e, hispanic_col] == 1])
        num_Mr_predict = len([e for e in range(0, num_test) if label_test_predicted[e] == 1 and sample_test[e, gender_col] == 1 and sample_test[e, hispanic_col] == 0])
