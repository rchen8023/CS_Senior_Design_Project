...
data = np.genfromtxt('student-mat_Cleaned.csv', delimiter=',', usecols=np.arange(0,46))
...
for i in range(0,10):
    ...
    num_men_dropout = len([e for e in range(0, n - num_train) if label_test[e] == 0 and sample_test[e, 0] == 1])
    num_women_dropout = len([e for e in range(0, n - num_train) if label_test[e] == 0 and sample_test[e, 0] == 0])
    ...
    num_men_incorrect = len([e for e in range(0, n - num_train) if label_test_predicted[e] == 0 and label_test[e] == 1 and sample_test[e, 0] == 1])
    num_women_incorrect = len([e for e in range(0, n - num_train) if label_test_predicted[e] == 0 and label_test[e] == 1 and sample_test[e, 0] == 0])
    ...
    num_men_predict = len([e for e in range(0, n - num_train) if label_test_predicted[e] == 0 and sample_test[e, 0] == 1])
    num_women_predict = len([e for e in range(0, n - num_train) if label_test_predicted[e] == 0 and sample_test[e, 0] == 0])
