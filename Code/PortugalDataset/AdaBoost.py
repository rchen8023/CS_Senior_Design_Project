...
plt.title('AdaBoost with 10 Trials (Gender)')
plt.legend()
plt.show()
...
plt.xlabel('Number of Training Instances')
plt.ylabel('Probability')
plt.title('AdaBoost with 10 Trials (Address)')
plt.legend()
plt.show()
...
plt.xlabel('Number of Training Instances')
plt.ylabel('Probability')
plt.title('AdaBoost with 10 Trials (Mu vs. Wr)')
plt.legend()
plt.show()
...
plt.xlabel('Number of Training Instances')
plt.ylabel('Probability')
plt.title('AdaBoost with 10 Trials (Wu vs. Mr)')
plt.legend()
plt.show()
...
plt.xlabel('Number of Training Instances')
plt.ylabel('Probability')
plt.title('AdaBoost with 10 Trials (Mu vs. others)')
plt.legend()
plt.show()
...
plt.xlabel('Number of Training Instances')
plt.ylabel('Probability')
plt.title('AdaBoost with 10 Trials (Wr vs. others)')
plt.legend()
plt.show()
...
plt.xlabel('Number of Training Instances')
plt.ylabel('Probability')
plt.title('AdaBoost with 10 Trials (Wu vs. others)')
plt.legend()
plt.show()
...
plt.xlabel('Number of Training Instances')
plt.ylabel('Probability')
plt.title('AdaBoost with 10 Trials (Mr vs. others)')
plt.legend()
plt.show()
