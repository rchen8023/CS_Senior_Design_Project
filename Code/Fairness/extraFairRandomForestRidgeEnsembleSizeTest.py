...
model = FairExtraRandomForestClassifier(gender_fair = True, address_fair = False, max_depth = 23, num_trees = 500)
...
for k in range(0, num_trial):
    ...
    for i in range(0, num_train_trial):
        ...
        model.fit(sample_train,label_train, num_fair_trees = num_models)
